...
- การตั้งค่า IP บน PC
  IP Address เปรียบเสมือน "บ้านเลขที่" ของอุปกรณ์ทุกชนิดที่ต่ออินเทอร์เน็ต
  โครงสร้างภายใน IP Address:
  ในบ้านเลขที่หนึ่งตัว จะประกอบด้วยข้อมูล 2 ส่วนเสมอ คือ:
   1.Network ID (ชื่อหมู่บ้าน/ชื่อเครือข่าย): บอกว่าอุปกรณ์นี้อยู่ในเน็ตเวิร์กวงไหน
   2.Host ID (บ้านเลขที่เฉพาะตัว): บอกว่าเป็นคอมพิวเตอร์เครื่องไหนในหมู่บ้านนั้น
- การตั้งค่า IP บน Router Interface
- Subnet Mask และ Default Gateway
  ### Subnet Mask (ซับเน็ต มาร์ก)
   Subnet Mask เปรียบเสมือน "ตัวแบ่งเขตแดน" หรือตัวเส้นคั่นหน้าตาเหมือน IP Address ที่จะบอกคอมพิวเตอร์ว่า "ตัวเลขส่วนไหนใน IP Address คือชื่อหมู่บ้าน (Network) และส่วนไหนคือเลขที่บ้าน (Host)
   ### Default Gateway คือ หมายเลขไอพีแอดเดรส (IP Address) ของอุปกรณ์เครือข่าย (เช่น เราเตอร์หรือโมเด็ม) ทำหน้าที่เป็นประตูทางออกหลัก เมื่ออุปกรณ์ของคุณต้องการส่งข้อมูลออกไปยังเครือข่ายภายนอกหรืออินเทอร์เน็ต
